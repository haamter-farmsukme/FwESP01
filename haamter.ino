...
const char* ssid1     = "MinerNetwork";        //<-- ใส่ชือ Wifi รอง ตรงนี ถ้าใช้ WiFi ตัวเดียวก็ให้ใส่เหมือนกันกับ ssid1
const char* password1 = "123456789";         //<-- ใส่รหัส Wifi รอง ตรงนี

const char* ssid2     = "Narong_2.4G";        //<-- ใส่ชือ Wifi หลัก
const char* password2 = "29518518";         //<-- ใส่รหัส Wifi หลัก ตรงนี
...
String AcctName       = "haamter";  //<-- ใส่ชือ User Name ตรงนี
String BrdNm          = "ESP-M1"; //<-- ใส่ชือ RigName ตรงนี
...
//Thanormsin
#define URL_fw_Version "/haamter-farmsukme/FwESP01/master/bin_version.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/haamter-farmsukme/FwESP01/master/haamter.bin"
